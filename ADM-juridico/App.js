...
import TelaAbrirProcesso from './screens/AbrirProcesso'
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name ="TelaAbrirProcesso" component={TelaAbrirProcesso} options={{title: 'Abrir Processo', headerTitleAlign: 'center'}} />
